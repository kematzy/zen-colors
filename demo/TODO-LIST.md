...
Fine-tuning for the demo page. Status as of the responsive UX pass.

| # | Item | Status |
|---|---|---|
| 1 | Title strapline | **Done** |
| 2 | Default neutral color `oklch(52.1% 0.023 104)` | **Done** |
| 3 | No `*-[var(--color-*)]` — use theme utilities | **Done** |
...
| 11 | Contrast mode polish | **Deferred** (per request) |
| 12 | Docs single page | **Done** |
